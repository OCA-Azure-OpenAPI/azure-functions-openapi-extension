...
namespace Microsoft.Azure.WebJobs.Extensions.OpenApi.Document.Tests
{
    ...
    public class Get_ApplicationJson_DictionaryObject_Tests
    {
        ...
        [DataTestMethod]
        [DataRow("dictionaryObjectModel", "object", "stringArrayValue", "object")]
        ...
        [DataTestMethod]
        [DataRow("dictionaryObjectModel", "object", "stringArrayValue", "object")]
        public void Given_OpenApiDocument_Then_It_Should_Return_ComponentSchemaAdditionalProperty(string @ref, string refType, string propertyName, string @additionalRef, string additionalRefType)
        {
            var additionalProperties = this._doc["components"]["schemas"][@ref]["properties"][propertyName]["additionalProperties"];

            var value = additionalProperties[@additionalRef];

            value.Should().NotBeNull();
            value.Value<string>("type").Should().Be(additionalRefType);
